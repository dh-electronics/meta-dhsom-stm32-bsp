...
# with application of relocated DT and DTOs at 0xcff00000 , clamp the
# initrd relocation address below UBOOT_DTB_LOADADDRESS = 0xcff00000.
if test -z "${initrd_high}" ; then
  setenv initrd_high 0xcff00000
fi
